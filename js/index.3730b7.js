...
function em1(){var c="BENJOAXZ.IG/DPN";var addr="mailto:";for(var i=0;i<c.length;i++)addr+=String.fromCharCode(c.charCodeAt(i)-1);window.location.href=addr;}
...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js1');e.setAttribute('src',(dpi>1)?'images/wy-hf-logo-1920.jpg':'images/wy-hf-logo-960.jpg');};
